...
class LinxDevice
{
  public:
    ...
    ****************************************************************************************/
    ...
    //TMC5160 Stepper 
    virtual int Motor_Init(uint8_t ID)=0;
    ...
    virtual int Move(uint8_t Motor_Id,uint32_t Velocity,unsigned char Direction)=0;
    virtual int Motor_stop(uint8_t Motor_Id)=0;
    virtual int Move_Absolute(uint8_t Motor_Id,int32_t Position,uint32_t Velocity)=0;
    virtual int Move_Relative(uint8_t Motor_Id,int32_t *steps,uint32_t Velocity)=0;
    //virtual int *Get_Data(uint8_t Motor_Id)=0;
    virtual uint32_t  Get_Data(uint8_t Motor_Id)=0;
    virtual int Position_clear(uint8_t Motor_Id)=0;
    virtual uint8_t Sensor(uint8_t Pin_num,unsigned char Input,uint8_t value)=0;
    virtual int Ref_serach(uint8_t Motor_Id,uint8_t Pin_num,uint8_t vel_divider,uint32_t Home_Velocity,uint8_t pp)=0;
  private:
    /****************************************************************************************
    **  Variables
    ****************************************************************************************/
